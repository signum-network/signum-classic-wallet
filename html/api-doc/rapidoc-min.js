/*! RapiDoc 9.3.3-signum | Author - Mrinmoy Majumdar | License information can be found in rapidoc-min.js.LICENSE.txt  */
      ...
      <div class = "tr primitive" title="${l||"deprecated"===O?"Deprecated":""}">
        ...
        <div class='td key-descr'>
          ...
          ${S?F`<span class="m-markdown-small">
              ${pR(Be(`${A?`**${A}:**`:""} ${S} ${x||w||$||k?'<span class="more-content">⤵</span>':""}`))}
