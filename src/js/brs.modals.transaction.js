        ...
        if (transaction.type == 0) {
            ...
            case 1:
                ...
                for (var i = 0; i < transaction.attachment.recipients.length; i++) {
                    ...
                    const amount = BRS.formatAmount(recipient[1]) + ' ' + BRS.valueSuffix
                    if (i !== 0) {
                        recipientHtml += '<br />'
                    }
            ...
            case 2:
                ...
                BRS.sendRequest('getAsset', {
                    ...
                    const data = {
                        ...
                        asset_name: asset.name,
                        quantity: [transaction.attachment.quantityQNT, asset.decimals],
                        price_formatted_html: BRS.formatOrderPricePerWholeQNT(transaction.attachment.priceNQT, asset.decimals) + ' ' + BRS.valueSuffix,
                        total_formatted_html: BRS.formatAmount(BRS.calculateOrderTotalNQT(transaction.attachment.quantityQNT, transaction.attachment.priceNQT)) + ' ' + BRS.valueSuffix
                    }
            ...
            case 2:
                ...
                BRS.sendRequest('getDGSGood', {
                    ...
                    data = {
                        ...
                        item_name: goods.name,
                        new_price_formatted_html: BRS.formatAmount(transaction.attachment.priceNQT) + ' ' + BRS.valueSuffix,
                        seller: BRS.getAccountFormatted(goods, 'seller')
                    }
